...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMap.addMarker(new MarkerOptions().position(meetupLocation).title("Meetup Here"));
    ...
    private void  getClosestCleaner(){
        ...
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(meetupLocation.latitude, meetupLocation.longitude), radius);
